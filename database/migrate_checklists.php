...
require_once __DIR__ . '/../auth/functions.php'; // added for require_login() and is_admin()
...
// ---------------------------------------------------------------
$stmt = $conn->prepare("
    SELECT id, item_description, is_completed, unit_id
    FROM project_checklists
    WHERE project_id = ? AND unit_id IS NULL
");
