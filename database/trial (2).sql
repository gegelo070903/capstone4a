-- phpMyAdmin SQL Dump
-- Capstone Project: Supply and Construction Development Monitoring System
-- Final Database Schema with Updated Roles (super_admin, admin only)
--
-- Host: 127.0.0.1
...
-- PHP Version: 8.4.3
--
-- IMPORTANT: This is the final consolidated database
-- Roles: super_admin (User ID 1 only - Rowena Tupas), admin (all other users)
...
-- NOTE: Role ENUM updated - only 'super_admin' and 'admin' (no more 'constructor' or 'employee')
-- User ID 1 is LOCKED as super_admin (system owner)
--
...
(1, 'Rowena Tupas', 'Rowena Tupas', '$2y$12$vKqUfJk1KS5RqMyjwk5jbOfJoqAb2va7rKswYr/OdXLmhWnSc9cgO', 'super_admin', '2025-11-03 14:51:49', '2025-12-12 00:00:00', 'active'),
(2, 'Employee1', 'Engr. Batumbakal', '$2y$12$AkKHmSwBhWSAQYMkv9n87eJkyBVoXaCvfrIouEVHmzU4jFFb1kfFO', 'admin', '2025-11-03 14:51:49', '2025-12-12 00:00:00', 'active'),
(4, 'Employee2', 'Secretary Kim', '$2y$12$Y4mDBP06vB/Qa6DqMWZrq.ZWapIFmW2AyoUYgN9Av.t2VsKXYaCqu', 'admin', '2025-11-03 14:51:49', '2025-12-12 00:00:00', 'active'),
(5, 'gelo', 'Arch. Gel', '$2y$12$Y4mDBP06vB/Qa6DqMWZrq.ZWapIFmW2AyoUYgN9Av.t2VsKXYaCqu', 'admin', '2025-12-10 00:00:00', '2025-12-12 00:00:00', 'active');
...
CREATE TABLE `project_units` (
  ...
  CONSTRAINT `project_units_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `project_checklists` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_checklist_item` (`project_id`,`unit_id`,`item_description`),
  ...
  CONSTRAINT `project_checklists_ibfk_2` FOREIGN KEY (`completed_by_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `project_checklists_ibfk_3` FOREIGN KEY (`unit_id`) REFERENCES `project_units` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `checklist_images` (
  ...
  CONSTRAINT `checklist_images_ibfk_1` FOREIGN KEY (`checklist_id`) REFERENCES `project_checklists` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `materials` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `fk_project_materials` (`project_id`),
  CONSTRAINT `fk_project_materials` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `report_images` (
  ...
  CONSTRAINT `report_images_ibfk_1` FOREIGN KEY (`report_id`) REFERENCES `project_reports` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS `report_material_usage`;
CREATE TABLE `report_material_usage` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_report_material` (`report_id`,`material_id`),
  KEY `material_id` (`material_id`),
  CONSTRAINT `report_material_usage_ibfk_1` FOREIGN KEY (`report_id`) REFERENCES `project_reports` (`id`) ON DELETE CASCADE,
  CONSTRAINT `report_material_usage_ibfk_2` FOREIGN KEY (`material_id`) REFERENCES `materials` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
